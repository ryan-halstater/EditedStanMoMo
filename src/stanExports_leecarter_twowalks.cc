...
#include "stanExports_leecarter_twowalks.h"

RCPP_MODULE(stan_fit4leecarter_twowalks_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_leecarter_twowalks")
