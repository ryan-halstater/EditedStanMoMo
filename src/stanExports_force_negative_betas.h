...
namespace model_force_negative_betas_namespace {
...
class model_force_negative_betas final : public model_base_crtp<model_force_negative_betas> {
private:
  int J;
  int T;
  std::vector<int> d;
...
public:
  ~model_force_negative_betas() { }
  
  inline std::string model_name() const final { return "model_force_negative_betas"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_force_negative_betas(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_force_negative_betas_namespace::model_force_negative_betas";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_force_negative_betas_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      } 
      {
        ...
        lp_accum__.add(uniform_lpdf<false>(b1, -1, 0));
        current_statement__ = 73;
        lp_accum__.add(uniform_lpdf<false>(b2, -1, 0));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_force_negative_betas_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_force_negative_betas_namespace::model_force_negative_betas;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_force_negative_betas_namespace::profiles__;
}
#endif
#endif
