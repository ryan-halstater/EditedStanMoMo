...
#include "stanExports_force_negative_betas.h"

RCPP_MODULE(stan_fit4force_negative_betas_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_force_negative_betas")
